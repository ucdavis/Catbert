IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'usp_getRolesInAppByLoginID')
	BEGIN
		DROP  Procedure  usp_getRolesInAppByLoginID
	END

GO

CREATE Procedure usp_getRolesInAppByLoginID
