    ...
    <xsl:sort select="@Name" order="ascending"/>
        ...
        <table cellpadding="2" cellspacing="0" width="98%" border="1" bordercolor="white" class="infotable">
            ...
            <xsl:for-each select="source">
                ...
                <tr class="row">
                    <td class="content">
                        <A HREF="javascript:"><xsl:attribute name="onClick">javascript:document.images['<xsl:value-of select="$source-id"/>'].click()</xsl:attribute><IMG border="0" _locID="IMG.alt" _locAttrData="alt"  alt="expand/collapse section" class="expandable" height="11" onclick="changepic()" src="_ConversionReport_Files/ConversionReport_Plus.gif" width="9" ><xsl:attribute name="name"><xsl:value-of select="$source-id"/></xsl:attribute><xsl:attribute name="child">src<xsl:value-of select="$source-id"/></xsl:attribute></IMG></A>&#32;<xsl:value-of select="@name"/> 
                    </td>
                    <td class="content">
                ...
                <tr class="collapsed" bgcolor="#ffffff">
                    ...
                    <td colspan="7">
                        <table width="97%" border="1" bordercolor="#dcdcdc" rules="cols" class="issuetable">
                            <tr>
                                <td colspan="7" class="issuetitle" _locID="ConversionIssues">Conversion Report</td>
                            </tr>
    ...
    <xsl:template match="UpgradeLog">
        <html>
            <head>
                ...
                <link rel="stylesheet" href="_ConversionReport_Files\ConversionReport.css" />
                ...
                <script language="javascript">
                    ...
                    function changepic() {
                        ...
                        {
                            uMe.src = "_ConversionReport_Files/ConversionReport_Minus.gif"
                        }
                        else
                        {
                            uMe.src = "_ConversionReport_Files/ConversionReport_Plus.gif"
                        }
                    }
                </script>
            </head>
            <body topmargin="0" leftmargin="0" rightmargin="0" onclick="outliner();">
                <h1 _locID="ConversionReport">Conversion Report</h1>
              
                <p>
                  <span class="note">
                    <b _locID="ConversionHelpLink">
                      <a href="http://msdn.microsoft.com/query/dev10.query?appId=Dev10IDEF1&amp;l=EN-US&amp;k=k(SQL.DATA.TOOLS.PROJECTCONVERSION.DIALOG)&amp;rd=true">Learn more about converting to SQL Server Database projects.</a>
                    </b>
                  </span>
                </p>
