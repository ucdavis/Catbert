...
namespace Catbert4.Tests.Controllers.UserManagementControllerTests
{
    public partial class UserManagementControllerTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodRemoveUnitContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethod("RemoveUnit");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodRemovePermissionContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethod("RemovePermission");
            #endregion Arrange
